...
void ChartWriter::writeAllCharts()
{
	...
	std::string statusGraphCommand = "gnuplot -e \""
										...
										"plot 'covid-status-results-group-0.dat' using 1:2 title 'Healthy (" + CHART_UNIVERISTY_STATUS_NICE_NAMES[0] + ")' with lines linecolor rgb '#267F00' lw 2,"
											...
											"'covid-status-results-group-0.dat' using 1:5 title 'Recovered (" + CHART_UNIVERISTY_STATUS_NICE_NAMES[0] + ")' with lines linecolor rgb '#0026FF' lw 2,"
											"'covid-status-results-group-1.dat' using 1:5 title 'Recovered (" + CHART_UNIVERISTY_STATUS_NICE_NAMES[1] + ")' with lines linecolor rgb '#0094FF' lw 2,"
											"'covid-status-results-group-2.dat' using 1:5 title 'Recovered (" + CHART_UNIVERISTY_STATUS_NICE_NAMES[2] + ")' with lines linecolor rgb '#00E5FF' lw 2,"
											"'covid-status-results-group-3.dat' using 1:5 title 'Recovered (" + CHART_UNIVERISTY_STATUS_NICE_NAMES[3] + ")' with lines linecolor rgb '#2E00AD' lw 2,"
											"'covid-status-results-group-0.dat' using 1:4 title 'Dead (" + CHART_UNIVERISTY_STATUS_NICE_NAMES[0] + ")' with lines linecolor rgb '#000000' lw 2,"
											"'covid-status-results-group-1.dat' using 1:4 title 'Dead (" + CHART_UNIVERISTY_STATUS_NICE_NAMES[1] + ")' with lines linecolor rgb '#898989' lw 2,"
											"'covid-status-results-group-2.dat' using 1:4 title 'Dead (" + CHART_UNIVERISTY_STATUS_NICE_NAMES[2] + ")' with lines linecolor rgb '#4C4C4C' lw 2,"
											"'covid-status-results-group-3.dat' using 1:4 title 'Dead (" + CHART_UNIVERISTY_STATUS_NICE_NAMES[3] + ")' with lines linecolor rgb '#707070' lw 2;"
									"\"";
